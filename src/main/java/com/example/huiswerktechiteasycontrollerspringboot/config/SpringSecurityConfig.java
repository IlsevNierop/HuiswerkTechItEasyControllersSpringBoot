package com.example.huiswerktechiteasycontrollerspringboot.config;

import com.example.huiswerktechiteasycontrollerspringboot.filter.JwtRequestFilter;
...
public class SpringSecurityConfig {
    ...
    protected SecurityFilterChain filter (HttpSecurity http) throws Exception {
        ...
        http
                ...
                .requestMatchers(HttpMethod.POST,  "/cimodules/**").hasRole("ADMIN").requestMatchers(HttpMethod.DELETE,  "/remotecontrollers").hasRole("ADMIN")
                ...
                .requestMatchers( "/cimodules/**", "/remotecontrollers", "/wallbrackets","/televisions/**").hasAnyRole("ADMIN", "USER")
